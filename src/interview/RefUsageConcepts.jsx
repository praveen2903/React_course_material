...
Finds logo.png
          │
          ▼
Copies image into build folder
          │
          ▼
Generates unique URL
          │
          ▼
logo = "/assets/logo-ab123.png"

Rendered HTML
<img src="/assets/logo-ab123.png" alt="Logo" />


2. IMAGE INSIDE public FOLDER
─────────────────────────────────────────────
Folder Structure:-
public/
 └── logo.png
...
No Import Needed, Browser directly requests
<img src="/logo.png" />


3. CHECK WHAT IMPORT RETURNS
─────────────────────────────────────────────
import logo from "./logo.png";
console.log(logo);

Output:  "/assets/logo-ab123.png"

Meaning: The imported image is NOT the image itself.
It is actually a STRING URL generated by Webpack/Vite.
...
5. DYNAMIC IMAGE PATH
─────────────────────────────────────────────
const imageName = "cat";
<img src={\`/images/\${imageName}.png\`} />

Result: <img src="/images/cat.png" />
...
import logo from "./logo.png";
          │
          ▼
React Bundler Reads File
          │
          ▼
Copies Image To Build Folder
          │
          ▼
Creates URL String
          │
